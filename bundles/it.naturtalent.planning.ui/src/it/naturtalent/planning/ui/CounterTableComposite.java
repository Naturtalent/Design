...
public class CounterTableComposite extends Composite
{
	...
	protected TableColumn tblclmnCount;
	 ...
	 * @param style
	 */
	public CounterTableComposite(Composite parent, int style)
	{
		super(parent, style);
		...
		tblclmnCount = tableViewerColumnLength.getColumn();
		tblclmnCount.setWidth(100);
		tblclmnCount.setText("Anzahl (St)");
