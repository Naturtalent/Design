...
/**
 * This is the item provider adapter for a {@link it.naturtalent.design.model.design.Shape} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DesignsPackage.Literals.SHAPE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addClassPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Shape_class_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Shape_class_feature", "_UI_Shape_type"),
				 DesignsPackage.Literals.SHAPE__CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addXPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Shape_x_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Shape_x_feature", "_UI_Shape_type"),
				 DesignsPackage.Literals.SHAPE__X,
				 true,
				 false,
				 false,
	...
	protected void addYPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Shape_y_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Shape_y_feature", "_UI_Shape_type"),
				 DesignsPackage.Literals.SHAPE__Y,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DesignsPackage.Literals.SHAPE__WIDTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DesignsPackage.Literals.SHAPE__HEIGHT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification)
	{
		...
		{
			case DesignsPackage.SHAPE__NAME:
			case DesignsPackage.SHAPE__CLASS:
			case DesignsPackage.SHAPE__X:
			case DesignsPackage.SHAPE__Y:
			case DesignsPackage.SHAPE__WIDTH:
			case DesignsPackage.SHAPE__HEIGHT:
