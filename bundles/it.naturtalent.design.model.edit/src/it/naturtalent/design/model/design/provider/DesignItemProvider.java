...
/**
 * This is the item provider adapter for a {@link it.naturtalent.design.model.design.Design} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
	{
		if (itemPropertyDescriptors == null)
		{
			...
			addDesignURLPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Design_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Design_name_feature", "_UI_Design_type"),
				 DesignsPackage.Literals.DESIGN__NAME,
				 true,
				 false,
				 false,
	...
	protected void addScaleDenominatorPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Design_scaleDenominator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Design_scaleDenominator_feature", "_UI_Design_type"),
				 DesignsPackage.Literals.DESIGN__SCALE_DENOMINATOR,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Design URL feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDesignURLPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Design_designURL_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Design_designURL_feature", "_UI_Design_type"),
				 DesignsPackage.Literals.DESIGN__DESIGN_URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
