...
/**
 * Ueberwacht die Selektion der Pages im DrawDocument.
 * 
 * @author dieter
 *
 */
public class DrawPagePropertyListener extends PropChgHelper
{
	...
	public void propertyChange(PropertyChangeEvent aEvt) throws RuntimeException
	{
		...
		{						
			...
			System.out.println("ProChange: change: "+xNamed.getName());
		}
	}
