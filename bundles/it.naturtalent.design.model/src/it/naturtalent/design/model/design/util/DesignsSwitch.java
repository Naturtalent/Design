 ...
 * @generated
 */
public class DesignsSwitch<T> extends Switch<T>
{
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case DesignsPackage.DESIGNS:
			{
				Designs designs = (Designs)theEObject;
				T result = caseDesigns(designs);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DesignsPackage.DESIGN_GROUP:
			{
				DesignGroup designGroup = (DesignGroup)theEObject;
				T result = caseDesignGroup(designGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DesignsPackage.DESIGN:
			{
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Designs</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Designs</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDesigns(Designs object)
	{
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Design Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Design Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDesignGroup(DesignGroup object)
	{
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Layer Set</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Layer Set</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
